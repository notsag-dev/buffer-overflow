#!/usr/bin/python
"""
This script sends a pattern to the vulnerable server to identify
exactly what portion of it overwrites the value of the EIP registry
(the instruction pointer registry). By identifying the exact position
of the instruction pointer it is trivial to overwrite it to control
